...
import { List, Datagrid, DateField, TextField, ReferenceField, ReferenceInput, SelectInput, Edit, SimpleForm, DisabledInput, Create, EditButton } from 'react-admin';
...
export const ShowEdit = (props) => (
    <Edit title={<ShowTitle />} {...props}>
        <SimpleForm>
            ...
            <DateTimeInput source="start" label="Start time" options={{ format: 'DD/MM/YYYY, HH:mm:ss', ampm: false, clearable: true }} />
            <DateTimeInput source="end" label="End time" options={{ format: 'DD/MM/YYYY, HH:mm:ss', ampm: false, clearable: true }} />
            <ReferenceInput label="Production" source="production_id" reference="productions">
