  ...
  return Promise.all([
    ...
    .then(function(values) {
      ...
      return knex('shows').insert([
        ...
        {
          start: moment().year(2018).month(6).date(22).hour(18).minute(0).toISOString(),
          end: moment().year(2018).month(6).date(22).hour(22).minute(0).toISOString(),
          production_id: magicFluteId,
          venue_id: garsingtonVenueId,
        },
        {
          start: moment().year(2018).month(6).date(24).hour(18).minute(0).toISOString(),
          end: moment().year(2018).month(6).date(24).hour(22).minute(0).toISOString(),
          production_id: magicFluteId,
          venue_id: garsingtonVenueId,
        },
        {
          start: moment().year(2018).month(6).date(30).hour(18).minute(0).toISOString(),
          end: moment().year(2018).month(6).date(30).hour(22).minute(0).toISOString(),
          production_id: magicFluteId,
          venue_id: garsingtonVenueId,
        },
        {
          start: moment().year(2018).month(7).date(11).hour(18).minute(0).toISOString(),
          end: moment().year(2018).month(7).date(11).hour(22).minute(0).toISOString(),
          production_id: magicFluteId,
          venue_id: garsingtonVenueId,
        },
        {
          start: moment().year(2018).month(7).date(17).hour(18).minute(0).toISOString(),
          end: moment().year(2018).month(7).date(17).hour(22).minute(0).toISOString(),
          production_id: magicFluteId,
          venue_id: garsingtonVenueId,
        },
        {
          start: moment().year(2018).month(7).date(19).hour(18).minute(0).toISOString(),
          end: moment().year(2018).month(7).date(19).hour(22).minute(0).toISOString(),
          production_id: magicFluteId,
          venue_id: garsingtonVenueId,
        },
        {
          start: moment().year(2018).month(7).date(21).hour(18).minute(0).toISOString(),
          end: moment().year(2018).month(7).date(21).hour(22).minute(0).toISOString(),
          production_id: magicFluteId,
          venue_id: garsingtonVenueId,
        },
      ]);
      ...
      return knex('shows').insert([
        {
          ...
          end: moment().year(2018).month(6).date(16).hour(22).minute(0).toISOString(),
          production_id: falstaffId,
          venue_id: garsingtonVenueId,
        },
        {
          start: moment().year(2018).month(6).date(18).hour(18).minute(30).toISOString(),
          end: moment().year(2018).month(6).date(18).hour(22).minute(0).toISOString(),
          production_id: falstaffId,
          venue_id: garsingtonVenueId,
        },
        {
        ...
        },
        {
          ...
          end: moment().year(2018).month(6).date(29).hour(22).minute(0).toISOString(),
          production_id: falstaffId,
          venue_id: garsingtonVenueId,
        },
        {
          start: moment().year(2018).month(7).date(4).hour(18).minute(30).toISOString(),
          end: moment().year(2018).month(7).date(4).hour(22).minute(0).toISOString(),
          production_id: falstaffId,
          venue_id: garsingtonVenueId,
        },
        {
          start: moment().year(2018).month(7).date(7).hour(18).minute(30).toISOString(),
          end: moment().year(2018).month(7).date(7).hour(22).minute(0).toISOString(),
          production_id: falstaffId,
          venue_id: garsingtonVenueId,
        },
        {
          start: moment().year(2018).month(7).date(13).hour(18).minute(30).toISOString(),
          end: moment().year(2018).month(7).date(13).hour(22).minute(0).toISOString(),
          production_id: falstaffId,
          venue_id: garsingtonVenueId,
        },
        {
          start: moment().year(2018).month(7).date(15).hour(18).minute(30).toISOString(),
          end: moment().year(2018).month(7).date(15).hour(22).minute(0).toISOString(),
          production_id: falstaffId,
          venue_id: garsingtonVenueId,
        },
        {
          start: moment().year(2018).month(7).date(20).hour(18).minute(30).toISOString(),
          end: moment().year(2018).month(7).date(20).hour(22).minute(0).toISOString(),
          production_id: falstaffId,
          venue_id: garsingtonVenueId,
        },
        {
          start: moment().year(2018).month(7).date(22).hour(18).minute(30).toISOString(),
          end: moment().year(2018).month(7).date(22).hour(22).minute(0).toISOString(),
          production_id: falstaffId,
          venue_id: garsingtonVenueId,
        },
      ]);
      ...
      return knex('shows').insert([
        {
          ...
          end: moment().year(2018).month(7).date(14).hour(22).minute(0).toISOString(),
